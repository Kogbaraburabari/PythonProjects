...
![Overall Subscription Split](chart_pie.png)

**Distribution of customer age**
![Distribution of Customer Age](chart_age_hist.png)

**Distribution of account balance**
![Distribution of Account Balance](chart_balance_overall.png)

**Subscription rate by job type**
![Subscription Rate by Job Type](chart_job.png)

**Subscription rate by education level**
![Subscription Rate by Education Level](chart_education.png)

**Subscription rate by marital status**
![Subscription Rate by Marital Status](chart_marital.png)

**Subscription rate by age group**
![Subscription Rate by Age Group](chart_age_group.png)

**Subscription rate by previous campaign outcome**
![Subscription Rate by Previous Campaign Outcome](chart_poutcome.png)

**Subscription rate by contact method**
![Subscription Rate by Contact Method](chart_contact.png)

**Subscription rate by month**
![Subscription Rate by Month](chart_month.png)

**Correlation heatmap of numeric variables**
![Correlation Heatmap](chart_heatmap.png)

**Account balance by subscription outcome**
![Account Balance by Subscription Outcome](chart_balance_box.png)
